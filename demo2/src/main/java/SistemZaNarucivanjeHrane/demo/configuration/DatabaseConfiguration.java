...
public class DatabaseConfiguration {
    ...
    public boolean instantiate() {
        ...
        Lokacija lokacijaSrpskaSicilija = new Lokacija(60.23 , 22.14, "Veselina Maslese 54A");
        lokacijaRepository.save(lokacijaSrpskaSicilija);
        Lokacija lokacijaMorskiRaj = new Lokacija(25.76 ,89.9, "Kace Dejanovic 42");
        ...
        Porudzbina porudzbina = new Porudzbina(jelovnikSrpskaSicilija, restoranSrpskaSicilija, LocalDateTime.now(), 510, kupacJovan, Status.U_PRIPREMI);
